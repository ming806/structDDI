...
if __name__ == "__main__":
    ...
    # (83040, 5)
    df_interact = pd.read_csv("../ddi_binary_interaction_raw.csv", usecols=['smiles1', 'smiles2', 'label'])
    print(df_interact.shape)
    map_dic = load_decompressed_pzip("../ddi_binary_raw_smiles_nodeId_dic.pzip")
    ...
    edge_df.to_csv("../ddi_binary_raw_interaction_cleaned_indexed.csv", index=False)
    print(edge_df.shape)
    ...
    store_compressed_pzip(edge_list, "../ddi_binary_raw_interaction_cleaned_indexed.pzip")